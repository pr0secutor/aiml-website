  ...
  return (
    <Flex flexDir={'column'}>
        ...
        <VStack mt={24} mb={20} alignItems={'center'} spacing={24}>
          <Heading size={['xl','2xl','3xl']} borderBottom={'solid'} borderBottomColor={'#EC3750'} borderBottomWidth={8} width={'fit-content'} ml={'auto'} mr={'auto'} textAlign={'center'}>Check Out The Latest Advancements in AI ML</Heading>
          <InitiativesCard
