import { Button, Card, CardBody, Flex, Heading, IconButton, SimpleGrid, Stack, VStack } from '@chakra-ui/react'
  ...
  return (
    <Flex flexDirection={'column'}>
        ...
        <Flex flexDirection={'column'} mt={24}>
          ...
          <Button as='a' href='' colorScheme={'red'} variant="outline" borderRadius={20} width={'160px'} ml={'auto'} mr={'auto'} mt={4} mb={4}>
              View All Events
            </Button>
        </Flex>
